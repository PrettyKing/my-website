...
源代码下载： [learnc-cn.c](https://learnxinyminutes.com/docs/files/learnc-cn.c)
...
使用合适的空格、缩进，保持一致的代码风格非常重要。可读性强的代码比聪明的代码、高速的代码更重要。可以参考下[Linux内核编码风格](https://www.kernel.org/doc/Documentation/CodingStyle) 。 除了这些，多多Google吧
